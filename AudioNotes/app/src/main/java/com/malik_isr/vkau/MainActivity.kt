...
class MainActivity : AppCompatActivity(), AudioAdapter.AudioList {
    ...
    private fun animRenameOpen() = with(binding){
        val centerX = (rcView.parent as View).width / 2.0f
        val centerY = (rcView.parent as View).height / 2.0f
        ...
        reName.startAnimation(animationSet)
        reName.visibility = View.VISIBLE
        startStopBlue.visibility =View.INVISIBLE
    }

    private fun animRenameClose()= with(binding){
        val centerX = (rcView.parent as View).width / 2.0f
        val centerY = (rcView.parent as View).height / 2.0f
        val scaleAnimation = ScaleAnimation(
            1.0f, 0.0f,
        ...
        edTextReName.setText("")
        startStopBlue.visibility =View.VISIBLE
    }
